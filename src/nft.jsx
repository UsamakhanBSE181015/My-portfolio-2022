...
export default function portfolio() {
  return (
    <div>
      ...
      <div className="logo">
        <p><a className="nft" href="/"><img className="logo" src="/images/logo2.png" height="auto" width="120px" alt="Sparsh Bajaj | Visual Artist" /></a></p>
      </div>
      <nav className="col-3">
        <div>
        ...
        <div className="bnr col-12">
          <div className="bnr_c">
            ...
            <div className="intro">
              <p className="delay">
                <span className="row">
                  <span data-emergence="hidden">Hello! I'm Usama Khan, based Islamabad, Pakistan</span>
                </span>
                <span className="row">
          ...
          <div className="bnr_t">
            <div className="no-out" style={{ zIndex: 1 }}>
              <h1 className="luxy-el" data-horizontal={1} data-speed-x={-35}>
                <span className="row">
                  <span data-emergence="hidden">UX UX UX UX UX UX</span>
                </span>
              </h1>
              <h1 className="le luxy-el" data-horizontal={1} data-speed-x={35}>
                <span className="row">
                  <span data-emergence="hidden">My UX UI Projects</span>
                </span>
              </h1>
            </div>
      ...
      <div className="wrk">
        <div className="wrk_t">
            <h1>
              <span className="row">
                <span className="outline -o" data-emergence="hidden">Inspiration</span>
              </span>
              <span className="row">
                <span data-emergence="hidden">Inspiration</span>
              </span>
            </h1>
        </div>
          <ImageComponents />
